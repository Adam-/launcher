...
extern "C" JNIEXPORT jboolean JNICALL Java_net_runelite_launcher_FilePermissionManager_regDeleteValue(JNIEnv *env, jclass clazz, jstring keyObj, jstring subKeyObj, jstring valueObj) {
